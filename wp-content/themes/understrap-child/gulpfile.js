...
// Copy all Font Awesome Fonts
	...
	gulp.src(basePaths.node + 'slick-carousel/slick/fonts/**/*.{ttf,woff,woff2,eof,svg}')
        .pipe(gulp.dest('./libs/slick-carousel/fonts'));
...
// Copy Popper JS files
	...
	gulp.src(basePaths.node + '/slick-carousel/slick/slick.min.js')
        .pipe(gulp.dest('./libs/slick-carousel'));	
